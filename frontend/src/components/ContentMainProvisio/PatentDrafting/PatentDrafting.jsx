...
const PatentDrafting = () => {
  ...
  useEffect(() => {
    const storedAnswer1 = localStorage.getItem("answerProvisio");
    const storedAnswer2 = localStorage.getItem("answerProvisio2");
    const storedAnswer3 = localStorage.getItem("answerProvisio3");
    const storedAnswer4 = localStorage.getItem("answerProvisio4");
    const storedAnswer5 = localStorage.getItem("answerProvisio5");
    const storedAnswer6 = localStorage.getItem("answerProvisio6");
    if (
      storedAnswer1 &&
      storedAnswer2 &&
      storedAnswer3 &&
